            ...
            {!user ? (
              ...
              <div className="relative">
                <img
                  ...
                  src={
                    user?.user?.image ??
                    "https://cdn.discordapp.com/avatars/1113245569490616400/a_c2f162676b5a2be3a835f01fe19c0559.gif?size=1024"
                  }
                ...
                {dropdownOpen && (
                  <div
                    id="dropdown"
                    className="z-10 absolute right-0 mt-2 bg-white divide-y divide-gray-200 rounded-lg shadow-md w-36 dark:bg-neutral-800 border border-zinc-700 transition duration-300 ease-in-out opacity-100 scale-100 transform origin-top"
                  >
                    <ul
                    ...
                    >
                      ...
                      <li>
                        <a
                          href="#"
                          className="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
