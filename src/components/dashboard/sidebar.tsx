...
export function Sidebar({ isMobile, isOpen, Guild }: SidebarProps) {
  ...
  return (
    ...
    >
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <div className="flex items-center gap-3 p-4 cursor-pointer hover:bg-zinc-700/50">
            ...
            <div className="flex-1">
              <h2 className="text-sm font-semibold text-white">{Guild.name}</h2>
        ...
        <DropdownMenuContent className="w-56 bg-[#1E1F22] text-zinc-200 border-zinc-800">
          <DropdownMenuItem
            ...
            className="focus:bg-zinc-700/50 focus:text-white"
          >
            Switch Server
          </DropdownMenuItem>{" "}
        </DropdownMenuContent>
      ...
      <div className="px-2">
        <div className="mb-4">
          <h3 className="mb-2 px-4 text-xs font-semibold text-zinc-400">
            MAIN SETTINGS
          </h3>
          <Button
            variant="ghost"
