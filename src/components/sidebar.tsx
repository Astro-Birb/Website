    ...
    return (
        <main>
            <button
                ...
                type="button"
                className="absolute top-20 left-4 sm:top-20 sm:left-8 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            ...
            <aside
                ref={sidebarRef}
                id="default-sidebar"
                className={`glassmorphisim fixed top-16 left-0 z-40 w-64 h-screen transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full sm:translate-x-0'
                    }`}
            >

                <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-neutral-900 dark:border-neutral-800">
                    <ul className="space-y-2 font-medium">
                        <div className="mt-4">
                            <div className="flex items-center p-3 space-x-3 bg-gray-100 dark:bg-neutral-800 rounded-lg">
                                <img
                                ...
                                <span className="text-gray-900 dark:text-white font-medium">{Guild.name}</span>
                            </div>
                        </div>
                        <li>
                        <a onClick={() => handleClick("overview")} className="onclickbutton flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3 flex-1">Infractions</span>
                            </a>
                        </li>
                        <li>
                            <a
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Auto Responder</span>
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
                            ...
                            <a onClick={() => HandleClick2("pricing")} className="onclickbutton flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                ...
                                <span className="ms-3">Upgrade to Premium</span>
                            </a>
                        </li>
                        <li>
                            <a onClick={() => HandleClick2("docs")} className="onclickbutton flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        ...
                        <li>
                            <a onClick={() => HandleClick2("support")} className="onclickbutton flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
