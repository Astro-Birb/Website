  ...
  return (
    <div className="dark overflow-auto flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-black text-white font-sans">
      ...
      <main className="relative flex-grow md:mt-16 sm:mb-72">
        <div className="flex flex-col items-center justify-center h-screen px-4 sm:scale-90 md:scale-100 mt-28 md:mt-0">
          ...
          <section className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-300">
              ...
              <span className="bg-gradient-to-r from-indigo-400 via-indigo-200 to-indigo-300
                     bg-clip-text text-transparent
                     animate-gradient-x">breeze</span>.
            </p>
            <div className="mt-8 flex space-x-4 justify-center font-semibold">
              ...
              >
                <button
                    className="px-6 py-3 font-semibold bg-indigo-600 border-indigo-900 text-white rounded-lg shadow-lg hover:bg-indigo-600 transition-colors">
                  Add To Discord
                </button>
              </a>
              <a
              ...
              >
                <button
                    className="px-6 py-3 text-pretty bg-gray-800 border border-gray-700 font-semibold text-white rounded-lg shadow-lg hover:bg-gray-700 transition-colors">
                  Support Server
                </button>
              </a>
            </div>
        ...
        <div
            className="relative flex flex-col md:flex-row items-center justify-between p-8 pb-24 max-w-screen-lg mx-auto md:ml-64 space-y-8 md:space-y-0 md:space-x-8">
          <div
              className="absolute inset-0 -top-4 -left-4 w-full h-full border-2 border-gray-500 opacity-20 rounded-lg transform scale-105 -z-10"></div>
