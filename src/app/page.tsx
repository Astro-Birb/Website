        ...
        <div className="flex flex-col items-center justify-center h-screen px-4 sm:scale-75 md:scale-125">
          ...
          <section className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-300">
              That helps you run your server with{" "}
              <span className="animated-gradient">ease</span>.
            </p>
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
              ...
              <p className="text-gray-300 sm:text-xl lg:text-2xl">
                Here at Astro Birb, we streamline the management of punishments
                and staff with robust features tailored for handling
                infractions, promotions, and monitoring message quotas
                effortlessly.
              </p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  At Astro Birb, our Discord bot is designed to guarantee
                  seamless operation without downtime, ensuring continuous
                  availability for all your needs.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  Easily manage your staff members with our comprehensive suite
                  of staff management modules at Astro Birb.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  We enable you to customize promotion, infraction, and other
                  embeds to suit your server's specific needs and design
                  preferences at Astro Birb.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  Our premium subscription at Astro Birb includes a variety of
                  useful add-ons designed to enhance your server experience.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  Astro Birb provides a variety of exciting modules that can
                  significantly enhance the enjoyment and engagement on your
                  server.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-300 text-center">
                  With our leave of absence module, you can easily submit a
                  request to have some time off!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
              <h2 className="mb-4 text-4xl tracking-tight font-bold text-gray-900 scale-125 dark:text-white">
                Our team
              </h2>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md">
            ...
            <p className="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">
              Astro Birb is a project that is constantly evolving. We are always
              looking for ways to improve our bot and make it more useful for
              our users. If you have any feedback or suggestions, please don't
            ...
            <div className="flex gap-3 items-center justify-start ">
              ...
              <a
                href="https://discord.gg/DhWdgfh3hN"
                className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
                Support Server
              </a>
            </div>
