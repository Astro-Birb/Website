                ...
                <section className="text-left max-w-4xl mx-auto pt-14">
                    ...
                    <article className="mb-8">
                        ...
                        <p className="text-lg text-gray-300 mb-4">
                            ...
                            <br />Using our services to facilitate in illegal activities or those that break Discord's Terms of Service/Community Guidelines
                            <br />Using our services to send advertisements to another user without their consent, or send messages at a high rate.
                            <br />Using our services in any way that may negatively impact the services or the reputation of the service/its staff team.
                        </p>
                    </article>
