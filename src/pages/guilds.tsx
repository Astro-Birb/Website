                  ...
                  <div key={guild.id} className="glassmorphism flex-shrink-0 w-72 max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-neutral-900 dark:border-neutral-700 mb-4">
                    ...
                    <div className="flex flex-col items-center pb-6">
                      ...
                      <div className="flex mt-2 md:mt-4">
                        <a href={`/dashboard/${guild.id}`} className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                          Dashboard
                        </a>
